...
/**
 * This example shows a stashing container that hides its children.
 */
public class StashingGridDemo {
	...
	private static Widget getContentWidget() {
		final StashingGrid grid = new StashingGrid(LayoutOrientation.HORIZONTAL, 3);
