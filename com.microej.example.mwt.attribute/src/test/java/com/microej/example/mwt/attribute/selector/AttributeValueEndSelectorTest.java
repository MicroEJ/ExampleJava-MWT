...
import com.microej.example.mwt.attribute.selector.AttributeValueEndSelector;

import ej.mwt.stylesheet.selector.SelectorHelper;

public class AttributeValueEndSelectorTest {
	...
	@Test
	public void test() {
		AttributeValueEndSelector selector = new AttributeValueEndSelector(ATTRIBUTE, VALUE);
