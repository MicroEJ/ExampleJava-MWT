...
import com.microej.example.mwt.attribute.selector.AttributeValuePrefixSelector;

import ej.mwt.stylesheet.selector.SelectorHelper;

public class AttributeValuePrefixSelectorTest {
	...
	@Test
	public void test() {
		AttributeValuePrefixSelector selector = new AttributeValuePrefixSelector(ATTRIBUTE, VALUE);
