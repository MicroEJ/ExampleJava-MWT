...
/**
 * Container that represents the watch.
 * <p>
...
class VirtualWatchContainer extends Container {
	...
	protected void renderContent(GraphicsContext g, int contentWidth, int contentHeight) {
		...
		TransformPainter.drawFlippedImage(g, this.image, 0, 0, this.flip);
	...
	public void flipImage() {
		this.flip = this.flip == Flip.FLIP_NONE ? Flip.FLIP_MIRROR : Flip.FLIP_NONE;
	}
