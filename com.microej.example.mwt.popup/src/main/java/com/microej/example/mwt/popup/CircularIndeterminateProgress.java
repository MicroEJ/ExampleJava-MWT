...
public class CircularIndeterminateProgress extends Widget {
	...
	private static final int OPTIMAL_DIAMETER = 100;
	...
	protected void renderContent(GraphicsContext g, int contentWidth, int contentHeight) {
		...
		int diameterMinusThickness = diameter - (thickness << 1);

		int x = Alignment.computeLeftX(diameterMinusThickness, 0, contentWidth, style.getHorizontalAlignment());
		int y = Alignment.computeTopY(diameterMinusThickness, 0, contentHeight, style.getVerticalAlignment());
